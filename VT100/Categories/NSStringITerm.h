...
- (NSDictionary *)attributesUsingFont:(UIFont *)font fittingSize:(CGSize)size attributes:(NSDictionary *)attributes;
...
- (CGRect)it_boundingRectWithSize:(CGSize)bounds attributes:(NSDictionary *)attributes truncated:(BOOL *)truncated;
