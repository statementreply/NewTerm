...
- (void)terminalMoveWindowTopLeftPointTo:(CGPoint)point;
...
- (CGPoint)terminalWindowTopLeftPixelCoordinate;
...
// Set various colors.
- (void)terminalSetForegroundColor:(UIColor *)color;
- (void)terminalSetBackgroundColor:(UIColor *)color;
- (void)terminalSetBoldColor:(UIColor *)color;
- (void)terminalSetSelectionColor:(UIColor *)color;
- (void)terminalSetSelectedTextColor:(UIColor *)color;
- (void)terminalSetCursorColor:(UIColor *)color;
- (void)terminalSetCursorTextColor:(UIColor *)color;
- (void)terminalSetColorTableEntryAtIndex:(int)n color:(UIColor *)color;

// Change the color tint of the current tab.
- (void)terminalSetCurrentTabColor:(UIColor *)color;
...
- (UIColor *)terminalColorForIndex:(int)index;
